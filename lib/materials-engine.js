 ...
 *
 * NOTE: repo folder structure (frontend/, backend/, docs/) isn't set
 * up yet (separate Sprint 0 card). This file is written as a
 * standalone ES module so it can be dropped into wherever that
 * structure lands (e.g. src/lib/ or backend/services/) without
 * changes.
 */
